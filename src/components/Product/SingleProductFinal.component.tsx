...
const SingleProductFinal = ({ product, recentRefurbishedReviews = [] }: { product: any, recentRefurbishedReviews?: any[] }) => {
                        ...
                        <div className="sticky top-24 flex flex-col gap-6">
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-5 shadow-sm">
                                <div className="flex flex-col gap-5">
                                    ...
                                    {isRefurbished && recentRefurbishedReviews && recentRefurbishedReviews.length > 0 && (
