...
interface MobilePhonesOnSaleProps {
    products: Product[];
}

const MobilePhonesOnSale = ({ products }: MobilePhonesOnSaleProps) => {
        ...
        <div className="bg-white py-1 border-t border-gray-100">
            <div className="w-full px-2 sm:px-6 relative group">
                <div className="flex items-center justify-between mb-2 pb-2">
                    <h2 className="text-xl text-gray-900 tracking-tight">Mobile Phones On Sale</h2>
                    <Link href="/product-category/mobile-phones" className="text-blue-600 text-md font-bold hover:underline">
                        View All
                    </Link>
                </div>
                ...
                <div className="md:hidden flex overflow-x-auto snap-x snap-mandatory gap-1 pb-4 no-scrollbar">
                    {products.map((product, index) => (
                        <div key={`mob-phones-${product.databaseId || index}`} className="snap-start shrink-0" style={{ width: '40vw' }}>
                            <ProductCard
                ...
                <div className="hidden md:block overflow-hidden relative min-h-[400px]">
                    ...
                    >
                        {products.map((product, index) => (
                            <div
                                key={`desk-phones-${product.databaseId || index}`}
                                className="px-2"
                                style={{
...
export default MobilePhonesOnSale;
