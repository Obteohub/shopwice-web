...
const StarRating: React.FC<StarRatingProps> = ({
    rating,
    size = 16,
    activeColor = '#ff6b01ff', // Orange-500 for filled stars
    inactiveColor = '#F97316', // Orange-500 for outlined stars (changed from gray)
}) => {
    ...
    return (
        <div className="flex items-center">
            {[1, 2, 3, 4, 5].map((star) => {
                ...
                return (
                    // All stars are filled, but with different colors
                    <svg
                        key={star}
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill={isFilled ? activeColor : '#FED7AA'} // Orange-500 for filled, orange-200 for unfilled
                        className="w-4 h-4"
                    >
                        <path
                            fillRule="evenodd"
